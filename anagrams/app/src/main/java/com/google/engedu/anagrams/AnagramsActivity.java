...
public class AnagramsActivity extends AppCompatActivity {
    ...
    public boolean defaultAction(View view) {
        ...
        TextView resultView = (TextView) findViewById(R.id.resultView);
        RadioButton anagramRadio = (RadioButton) findViewById(R.id.radio_anagram);
        RadioButton oneLetterRadio = (RadioButton) findViewById(R.id.radio_one_letter);
        RadioButton twoLetterRadio = (RadioButton) findViewById(R.id.radio_two_letters);
        if (currentWord == null) {
            currentWord = dictionary.pickGoodStarterWord();

            if(anagramRadio.isChecked()){
                anagrams = dictionary.getAnagrams(currentWord);
            }
            if(oneLetterRadio.isChecked()){
                anagrams = dictionary.getAnagramsWithOneMoreLetter(currentWord);
            }
            if(twoLetterRadio.isChecked()){
